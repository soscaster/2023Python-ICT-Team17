...
def modify_store():
    ...
    store_id.set(storefunc.get_store_info()[0])
    store_name.set(storefunc.get_store_info()[1])
    store_address.set(storefunc.get_store_info()[2])
    store_phone.set(storefunc.get_store_info()[3])
    store_email.set(storefunc.get_store_info()[4])
...
def modify_store_func():
    ...
    if storefunc.modify_store(store_id.get(), store_name.get(), store_address.get(), store_phone.get(), store_email.get()) == False:
        messagebox.showerror("Error", "Store info is not modified!")
    elif storefunc.modify_store(store_id.get(), store_name.get(), store_address.get(), store_phone.get(), store_email.get()) == True:
...
def modify_staff():
    ...
    # Get staff list
    staff_list = stafffunc.get_staff_list()
    ...
    def get_staff_info():
        staff_info = stafffunc.get_staff_info(st_ID.get())
    ...
    def delete_staff_func():
        if stafffunc.delete_staff(st_ID.get()) == True:
            ...
            if stafffunc.check_staff_table() == False:
                ...
                btn_staff['state'] = 'normal'
        elif stafffunc.delete_staff(st_ID.get()) == False:
...
if customerfunc.check_cus_table() == False:
